...
pixi add ninja-hep-ph ninja-hep-ph-static
# for installing globally
pixi global install ninja-hep-ph ninja-hep-ph-static
```
...
It is possible to list all of the versions of `ninja-hep-ph` available on your platform:
...
```
pixi search ninja-hep-ph --channel conda-forge
```
